...
console.log("Forma 1: Números pares");
// imprimir numeros en pares del 2 al 30
for (var i = 2; i <= 30; i += 2) {
    console.log(i);
}
console.log("Forma 2: Números pares");
// Alternativa usando módulo: pares
...
// imprimir solo multiplos de 4 de forma desendente desde el 100 al 4
